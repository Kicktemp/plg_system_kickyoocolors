...
export const config = {
  ...
  packagefiles: [
    {
      src: './releasefiles/plugins/system/kickyoocolors/**/**',
      dest: 'sourcefiles/plg_system_kickyoocolors'
    }
  ],
  archiver: [
    {
      destination : 'archives/',
      name: 'plg_system_kickyoocolors',
      suffixversion: true,
      types: [
        {
          extension: '.zip',
      ...
      folders: [
        'sourcefiles/plg_system_kickyoocolors'
      ],
      files: [
      ]
    }
